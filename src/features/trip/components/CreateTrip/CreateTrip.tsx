...
import { ArrowRight, CalendarCheck, ChevronLeft, History, MapPin, Sparkles } from 'lucide-react'
  ...
  const recentPlaces = [
    {
      ...
      distance: '500m',
      image:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuBCQakA9lZJTVVxH2hFxhdtYllwdp_h2pVNwMxI-8akTYzB8ZoLuI2ax5Bv6n24tkZ4CE73fk-Vwk_rdwfTxkINYEOwmrKHvwJ8QxosVpje8pR3cQ6VjzmG8_OFG10aFUiMiayzK37zLvQSxy7ydawjdGbYvo8PbkedbHuKRRD2_fveTMBUllcjztvRS8V_tclb2e-5VoA6-nI7R0fEcSAntVlde1bKmNNiCqystE_5kVAabiLAiFshn1JsdqHZnzPMkbLtm3vxaCS3',
    },
    {
      id: 'p2',
    ...
    >
      ...
      <section className='flex items-center gap-3 sm:gap-4'>
        ...
        <div className='min-w-0'>
          <h2 className='text-xl sm:text-3xl font-black text-on-surface tracking-tighter truncate leading-tight'>
            Bắt đầu chuyến đi
          </h2>
          <p className='text-[10px] sm:text-sm font-medium text-outline/60 truncate uppercase tracking-widest sm:normal-case sm:tracking-normal'>
            Lên kế hoạch hoàn hảo cho hành trình
          </p>
        </div>
      </section>
            ...
            <div className='absolute bottom-10 sm:bottom-16 left-0 px-6 sm:px-16 w-full'>
              ...
              >
                <span className='sm:hidden'>
                  Khám phá <br /> điểm đến mới
                </span>
                <span className='hidden sm:block'>
                  Khám phá & Lên lịch trình <br /> cho chuyến đi mới
                </span>
              </motion.h4>
              <motion.p
                initial={{ opacity: 0 }}
              ...
              >
                Tự do sáng tạo lộ trình, quản lý chi phí và kết nối các điểm đến tuyệt vời nhất cùng
                bạn bè.
              </motion.p>
            </div>
          </motion.div>
          ...
          <div className='flex justify-center -mt-8 sm:-mt-12 relative z-10 px-4'>
            <motion.button
              ...
              whileHover={{
                scale: 1.05,
                y: -6,
                boxShadow: '0 25px 50px -12px rgba(29,107,64,0.4)',
              }}
              whileTap={{ scale: 0.95 }}
              animate={{
                boxShadow: [
                  '0 15px 30px -12px rgba(29,107,64,0.3)',
                  '0 15px 30px -12px rgba(29,107,64,0.5)',
                  '0 15px 30px -12px rgba(29,107,64,0.3)',
                ],
              }}
      ...
      <section className='pt-6 sm:pt-14'>
        <div className='flex items-center justify-between mb-6 sm:mb-10'>
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <div>
              <h2 className='text-lg sm:text-2xl font-bold text-on-surface tracking-tight leading-none mb-1'>
                Gợi ý từ lịch sử
              </h2>
              <p className='text-[10px] sm:text-xs font-bold text-outline uppercase tracking-widest opacity-60'>
                Dành riêng cho bạn
              </p>
            </div>
          </div>
        ...
        <div className='relative overflow-hidden rounded-[24px] sm:rounded-[32px] bg-surface-container/30 border-2 border-dashed border-outline-variant/30 p-10 sm:p-20 text-center flex flex-col items-center'>
          ...
          <h3 className='text-lg sm:text-2xl font-black text-on-surface mb-3 tracking-tight'>
            Chào mừng nhà lữ hành mới!
          </h3>
          <p className='text-xs sm:text-base font-medium text-outline max-w-md mx-auto mb-8 leading-relaxed'>
            Bạn chưa có lịch sử tìm kiếm. Hãy bắt đầu bằng cách tìm kiếm những địa điểm thú vị để
            lưu vào danh sách gợi ý nhé.
          </p>
