...
import { 
  Users, Wallet, Camera, 
  MapPin, Sparkles, X, 
  Coffee, Utensils, Hotel, Tent, Landmark, Calculator, Navigation2, Info, Plus,
...
function ConfirmModal({ isOpen, onClose, onStartNow, onDoLater }: { isOpen: boolean, onClose: () => void, onStartNow: () => void, onDoLater: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      >
        ...
        <h3 className="text-xl font-black text-on-surface mb-3 tracking-tighter">Lịch trình đã sẵn sàng!</h3>
...
const ITINERARY_TYPES = [
  ...
  { id: 'landmark', label: 'Điểm tham quan', icon: Landmark, color: 'bg-purple-100 text-purple-700' },
...
const MOCK_PLACES = [
  { 
    ...
    icon: Coffee, 
    color: 'bg-emerald-50',
    image: 'https://lh3.googleusercontent.com/p/AF1QipM-XyUfV_pW_vZwB9yH-Z5Z9q7y4Z5Z9q7y4Z5Z=s1360-w1360-h1020'
  },
  { 
    id: 2, 
    ...
    icon: Landmark, 
    color: 'bg-purple-50',
    image: 'https://lh3.googleusercontent.com/p/AF1QipN9_8M5Zq5v-Z5Z9q7y4Z5Z9q7y4Z5Z9q7y4Z5Z=s1360-w1360-h1020'
  },
  { 
    id: 3, 
    ...
    icon: Utensils, 
    color: 'bg-orange-50',
    image: 'https://lh3.googleusercontent.com/p/AF1QipM7_6M5Zq5v-Z5Z9q7y4Z5Z9q7y4Z5Z9q7y4Z5Z=s1360-w1360-h1020'
  }
];
...
export default function TripItineraryBuild({ onBack }: TripItineraryBuildProps) {
  ...
  const isAnyModalOpen = showTimeline || showSuggestionsOverview || selectedPlace !== null || showSplitModal || showConfirmModal;
    ...
    >
      ...
      <div className="flex flex-row items-center justify-between gap-4">
        <div className="min-w-0 flex-1">
          <h1 className="text-lg sm:text-3xl font-black tracking-tighter text-on-surface leading-tight break-words">Thông tin chi tiết chuyến đi</h1>
          <nav className="flex items-center gap-2 mt-0.5 sm:mt-1">
            <button onClick={onBack} className="text-[9px] sm:text-xs text-outline font-medium hover:text-primary transition-colors">Hành trình</button>
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <button onClick={onBack} className="flex items-center gap-1.5 px-4 sm:px-6 py-2 sm:py-2.5 border-2 border-outline-variant rounded-[4px] text-[10px] sm:text-sm font-bold text-outline hover:bg-surface-container transition-all">
              Quay lại
            </button>
            <button 
              onClick={() => {
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex flex-row gap-3 sm:gap-5">
                <div className="w-[30%] sm:w-1/2 space-y-2">
                  <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Số người</label>
                  <input 
                    type="text" 
                    placeholder="Ví dụ: 4"
                ...
                <div className="w-[70%] sm:w-1/2 space-y-2">
                  <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Chi phí ước tính (VNĐ)</label>
              ...
              <div className="space-y-2">
                <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Địa điểm muốn tới</label>
                <div className="relative">
                  <MapPin size={16} className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-outline/40" />
                  <input 
                    type="text" 
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-5">
                <div className="space-y-2">
                  <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Kiểu chuyến đi</label>
                ...
                <div className="space-y-2">
                  <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Nhịp độ</label>
                  <select className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-surface-container border border-outline-variant/10 rounded-xl text-xs sm:text-sm font-bold focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none cursor-pointer">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-5">
                <div className="space-y-2">
                  <label className="text-[10px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Đi cùng ai</label>
                  <select className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-surface-container border border-outline-variant/10 rounded-xl text-xs sm:text-sm font-bold focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none cursor-pointer">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Phương tiện</label>
                  <select className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-surface-container border border-outline-variant/10 rounded-xl text-xs sm:text-sm font-bold focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none cursor-pointer">
              ...
              <div className="space-y-2">
                <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Yêu cầu thêm</label>
                <textarea 
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white rounded-[24px] border border-outline-variant/30 shadow-sm overflow-hidden group">
            <div className="relative h-48 sm:h-56">
              ...
              <div className="absolute top-4 left-4 flex flex-col gap-2">
                <span className="px-3 py-1 bg-primary text-[10px] font-black tracking-widest text-white rounded-full uppercase">Preview</span>
              </div>
              <div className="absolute bottom-4 left-4 right-4">
                <h3 className="text-xl font-black text-white leading-tight">Mùa hè rực rỡ tại Đà Lạt</h3>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-outline">Ngày đi</p>
                  <p className="text-sm font-bold text-on-surface">15 Th06, 2024</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-outline">Ngày về</p>
                  <p className="text-sm font-bold text-on-surface">20 Th06, 2024</p>
                </div>
              </div>

              <div className="space-y-2">
                <p className="text-[10px] font-black uppercase tracking-widest text-outline">Thành viên</p>
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-sm sm:text-base font-black text-on-surface">Xem phân loại lộ trình</p>
              <p className="text-[11px] sm:text-xs text-outline font-medium">Phân nhóm địa điểm theo loại hình</p>
            </div>
          ...
          <div className="bg-white rounded-[32px] border border-outline-variant/30 shadow-sm overflow-hidden">
            <div className="p-6 sm:p-8 flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b border-outline-variant/20">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 flex-1 min-w-0">
                <h2 className="text-xl sm:text-2xl font-black tracking-tight text-on-surface whitespace-nowrap">Lộ trình chi tiết</h2>
                
                {/* Search Bar */}
                <div className="relative group w-full sm:flex-1 sm:max-w-sm h-[50px] sm:h-[46px]">
                  <Search size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-outline/40 group-focus-within:text-primary transition-colors" />
                  <input 
                    type="text" 
                  ...
                  <div className="p-6 sm:p-10">
                    ...
                    >
                      <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center mx-auto text-primary">
                        <Navigation2 size={40} className={locationStatus === 'denied' ? 'text-error' : 'text-primary'} />
                      </div>
                      <div>
                        <h3 className="text-lg sm:text-xl font-black text-on-surface">
                          {locationStatus === 'denied' ? 'Quyền truy cập vị trí bị từ chối' : 'Cho phép truy cập vị trí'}
                        </h3>
                  ...
                  >
                    ...
                    <div className="lg:w-[60%] h-[350px] lg:h-auto relative bg-surface-container/50 border-r border-outline-variant/20 overflow-hidden">
                      ...
                      <div className="absolute bottom-6 left-6 right-6 flex justify-between items-center">
                         ...
                         <div className="flex gap-2">
                           <button className="p-2.5 bg-white rounded-[4px] shadow-md text-outline hover:text-primary transition-all"><Calculator size={18} /></button>
                           <button className="p-2.5 bg-primary text-white rounded-[4px] shadow-md transition-all active:scale-95"><Navigation2 size={18} /></button>
                         </div>
                      </div>
                    </div>
                    ...
                    <div className="lg:w-[40%] p-6 sm:p-8 lg:p-10 space-y-6 bg-surface-container/10">
                      <div className="flex items-center justify-between">
                        <h4 className="text-xs sm:text-sm font-black text-on-surface uppercase tracking-widest">Địa điểm gợi ý</h4>
                        <span className="text-[10px] sm:text-xs font-bold text-primary bg-primary/10 px-3 py-1 rounded-full">Nearby</span>
                      </div>
                      ...
                      <div className="space-y-4 lg:space-y-5 max-h-[650px] overflow-y-auto no-scrollbar pr-1">
                        {MOCK_PLACES.map((place) => (
                          ...
                          >
                            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden flex-shrink-0 bg-surface-container shadow-inner">
                              <img src={place.image} alt={place.name} className="w-full h-full object-cover transition-transform duration-700" />
                            </div>
                            <div className="flex-1 min-w-0 flex flex-col justify-between py-1">
                              <div>
                                <div className="flex items-center justify-between">
                                  <h5 className="text-sm sm:text-lg font-black text-on-surface truncate pr-2 tracking-tight">{place.name}</h5>
                                  <div className={`flex-shrink-0 p-1.5 rounded-lg ${place.color} text-current shadow-sm`}>
                                    <place.icon size={14} />
                                  </div>
                                </div>
                                <p className="text-[11px] sm:text-xs text-outline font-medium mt-1 truncate">{place.address}</p>
                              </div>
                              
                              <div className="flex items-center justify-between mt-2">
                                <span className="text-[10px] sm:text-[11px] font-black text-primary/80 bg-primary/5 px-2 py-0.5 rounded-md">{place.distance} • {place.time}</span>
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-2 mb-4">
                          ...
                          >
                             <Plus size={14} className="group-hover:rotate-90 transition-transform" /> Thêm địa điểm
                          </button>
                          <button 
                          ...
                          >
                             <Sparkles size={14} className="group-hover:scale-110 transition-transform" /> Xem thêm gợi ý
                          </button>
                        </div>
                      </div>
                    </div>
        ...
        {showSplitModal && (
          <SplitCostModal 
            ...
            onSave={(individualCosts) => {
              const total = Object.values(individualCosts).reduce((sum: number, val: string) => sum + parseInt(val.replace(/\D/g, '') || '0'), 0);
...
function TimelineModal({ onClose, onSelectPlace }: { onClose: () => void, onSelectPlace: (place: any, isEdit?: boolean) => void }) {
  ...
  const timelineData = {
    morning: [
      { id: 'm1', time: '07:00', name: 'Ăn sáng tại Phở Hiếu', address: 'Trương Công Định', image: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?q=80&w=400&auto=format&fit=crop', isExisting: true },
      { id: 'm2', time: '08:30', name: 'Tham quan Hồ Tuyền Lâm', address: 'P4, Đà Lạt', image: 'https://images.unsplash.com/photo-1596392916534-f46334969f64?q=80&w=400&auto=format&fit=crop', isExisting: true },
      { id: 'm3', time: '09:45', name: 'Thiền viện Trúc Lâm', address: 'Phượng Hoàng', image: 'https://images.unsplash.com/photo-1596400030589-9fc62af4f11b?q=80&w=400&auto=format&fit=crop', isExisting: true },
    ],
    afternoon: [
      { id: 'a1', time: '12:30', name: 'Ăn trưa & Nghỉ ngơi', address: 'Quán nướng ngói', image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?q=80&w=400&auto=format&fit=crop', isExisting: true },
      { id: 'a2', time: '15:00', name: 'Vườn hoa Cẩm Tú Cầu', address: 'Trại Mát', image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?q=80&w=400&auto=format&fit=crop', isExisting: true },
    ],
    evening: [
      { id: 'e1', time: '19:00', name: 'Phá đảo Chợ Đêm', address: 'Trung tâm Đà Lạt', image: 'https://images.unsplash.com/photo-1534073828943-f801091bb18c?q=80&w=400&auto=format&fit=crop', isExisting: true },
      { id: 'e2', time: '22:00', name: 'Về khách sạn & Nghỉ ngơi', address: 'Terracotta Resort', icon: Hotel, isExisting: true },
    ]
  };
        ...
        <div className="p-5 sm:p-8 flex flex-row items-center justify-between border-b border-outline-variant/10 bg-surface-container-low/30 gap-6">
          <div className="flex items-center gap-3 sm:gap-4 flex-1">
            ...
            <div className="min-w-0">
              <h2 className="text-base sm:text-2xl font-black text-on-surface tracking-tighter truncate md:whitespace-normal">Phân loại lộ trình</h2>
              <div className="flex items-center gap-2 mt-1">
                <MapPin size={12} className="text-primary" />
                <span className="text-[10px] sm:text-sm font-bold text-outline uppercase tracking-wider">Đà Lạt</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center sm:items-end gap-3 sm:gap-4 shrink-0 group relative cursor-pointer">
            <div className="text-right hidden sm:block">
              <p className="text-[10px] font-black text-outline uppercase tracking-[0.2em] mb-0.5">Ngày hiển thị</p>
              <span className="text-[10px] sm:text-xs font-black text-on-surface uppercase tracking-widest block">Tháng 06, 2024</span>
            </div>
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-2 sm:gap-4 bg-white px-4 py-2 sm:px-6 sm:py-3 rounded-2xl border border-outline-variant/10 shadow-sm group-hover:border-primary group-hover:shadow-lg transition-all">
                <span className="text-3xl sm:text-5xl font-black text-primary tracking-tighter leading-none">{selectedDate}</span>
                <div className="flex flex-col">
                  <span className="text-[10px] sm:hidden font-black text-on-surface uppercase tracking-widest">Th06</span>
                  <ChevronDown size={18} className="text-outline/30 group-hover:text-primary transition-colors mt-0.5" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar p-5 sm:p-8 bg-background/30">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 h-full">
            ...
            <div className="space-y-6">
              <SectionHeader icon={<Coffee size={18} />} title="Buổi Sáng" timeRange="(0h - 10h)" color="bg-orange-100/50 text-orange-600" />
              <div className="relative pl-6 sm:pl-8 space-y-8 sm:space-y-10">
                ...
                {timelineData.morning.map((item) => (
                  <TimelineCard key={item.id} item={item} onSelect={(p: any) => onSelectPlace(p, true)} />
                ))}
              </div>
            </div>
            ...
            {/* Afternoon Section */}
            <div className="space-y-6">
              <SectionHeader icon={<Utensils size={18} />} title="Trưa - Chiều" timeRange="(10h - 18h)" color="bg-primary/10 text-primary" />
              <div className="relative pl-6 sm:pl-8 space-y-8 sm:space-y-10">
                <div className="absolute left-[7px] top-2 bottom-2 w-0.5 border-l-2 border-dashed border-outline-variant/20" />
            ...
            {/* Evening Section */}
            <div className="space-y-6">
              <SectionHeader icon={<Hotel size={18} />} title="Buổi Tối" timeRange="(18h - 0h)" color="bg-indigo-100 text-indigo-600" />
              <div className="relative pl-6 sm:pl-8 space-y-8 sm:space-y-10">
                <div className="absolute left-[7px] top-2 bottom-2 w-0.5 border-l-2 border-dashed border-outline-variant/20" />
...
function SuggestionsOverviewModal({ onClose, onSelectPlace }: { onClose: () => void, onSelectPlace: (place: any) => void }) {
  const [selectedTime, setSelectedTime] = useState('morning');

  const suggestionTimeline = {
    morning: [
      { id: 101, name: 'Phở Hiền', status: 'Hoạt động mạnh: 06:00 - 10:00', type: 'Ẩm thực', address: '64 Lương Văn Can, Hoàn Kiếm, Hà Nội', image: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?q=80&w=400&auto=format&fit=crop' },
      { id: 102, name: 'Hồ Tuyền Lâm', status: 'Cảnh đẹp nhất: 07:00 - 09:00', type: 'Tham quan', address: 'Phường 4, Đà Lạt', image: 'https://images.unsplash.com/photo-1596392916534-f46334969f64?q=80&w=400&auto=format&fit=crop' },
    ],
    afternoon: [
      { id: 103, name: 'Quán nướng Chu', status: 'Hoạt động mạnh: 11:30 - 14:00', type: 'Ẩm thực', address: '03 Phạm Ngũ Lão, Đà Lạt', image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?q=80&w=400&auto=format&fit=crop' },
      { id: 104, name: 'Vườn hoa Cẩm Tú Cầu', status: 'Ánh sáng tốt: 15:00 - 17:00', type: 'Chụp ảnh', address: 'Trại Mát, Đà Lạt', image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?q=80&w=400&auto=format&fit=crop' },
    ],
    evening: [
      { id: 105, name: 'Chợ đêm Đà Lạt', status: 'Nhộn nhịp nhất: 19:00 - 22:00', type: 'Mua sắm', address: 'Trung tâm Đà Lạt', image: 'https://images.unsplash.com/photo-1534073828943-f801091bb18c?q=80&w=400&auto=format&fit=crop' },
      { id: 106, name: 'Lẩu gà lá é', status: 'Hoạt động mạnh: 18:30 - 21:00', type: 'Ẩm thực', address: 'Chu Văn An, Đà Lạt', image: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?q=80&w=400&auto=format&fit=crop' },
    ]
  };
        ...
        <div className="p-6 border-b border-outline-variant/10 flex justify-between items-center bg-surface-container-low/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] uppercase tracking-widest text-outline font-bold mt-1">Dựa trên nhịp sống địa phương</p>
            </div>
          </div>
          <button onClick={onClose} className="p-2 hover:bg-surface-container rounded-[4px] transition-colors">
            <X size={20} />
          </button>
        </div>
          ...
          {[
            ...
            <button
              ...
              className={`flex-1 py-3 px-2 flex items-center justify-center gap-1.5 text-[9px] sm:text-xs font-black uppercase tracking-widest border-b-2 whitespace-nowrap min-w-fit ${
                selectedTime === tab.id ? 'border-primary text-primary bg-primary/5' : 'border-transparent text-outline hover:bg-surface-container'
              }`}
            >
              <tab.icon size={14} />
              {tab.label}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          {(suggestionTimeline as any)[selectedTime].map((item: any) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  <h4 className="font-black text-on-surface text-sm truncate group-hover:text-primary transition-colors">{item.name}</h4>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-[10px] font-bold px-2 py-0.5 bg-primary/10 text-primary rounded-full">{item.type}</span>
                    <span className="text-[10px] text-outline font-medium truncate">{item.status}</span>
                  </div>
                </div>
              </div>
              <Sparkles size={16} className="text-primary opacity-0 group-hover:opacity-100 transition-opacity shrink-0" />
            </motion.div>
          ))}
          ...
          <div className="p-6 rounded-3xl bg-secondary/5 border border-secondary/10 flex items-center gap-4 mt-4">
            ...
            <p className="text-xs font-medium text-on-surface/70 leading-relaxed italic">
              "Thời gian gợi ý được tối ưu theo kinh nghiệm du lịch thực tế tại địa phương để bạn có trải nghiệm tốt nhất."
            </p>
          </div>
        </div>
...
function SectionHeader({ icon, title, timeRange, color }: { icon: any, title: string, timeRange: string, color: string }) {
  return (
    <div className="flex items-center gap-2 pb-4 border-b border-outline-variant/20">
      ...
      <h3 className="text-xs sm:text-sm font-black text-on-surface uppercase tracking-widest">
        {title} <span className="text-[10px] text-outline font-medium ml-1 lowercase">{timeRange}</span>
      </h3>
    </div>
  );
}
    ...
    <div className="relative">
      ...
      >
        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl overflow-hidden shrink-0 shadow-inner bg-surface-container">
          {item.image ? (
            <img src={item.image} alt={item.name} className="w-full h-full object-cover transition-transform duration-500" />
          ) : (
        ...
        <div className="flex-1 min-w-0">
          <span className="text-[9px] sm:text-[10px] font-black text-primary/80 block mb-0.5">{item.time}</span>
          <h4 className="font-black text-xs sm:text-sm text-on-surface truncate group-hover:text-primary transition-colors">{item.name}</h4>
    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto no-scrollbar">
          ...
          {isCustom ? (
             <div className="space-y-4">
               ...
               <div className="space-y-4">
                 <div className="space-y-1.5">
                   <label className="text-[9px] font-black uppercase tracking-widest text-outline">Tên địa điểm</label>
                   <input 
                     type="text"
                     value={name}
                 ...
                 <div className="space-y-1.5">
                   <label className="text-[9px] font-black uppercase tracking-widest text-outline">Địa chỉ</label>
                   <div className="relative">
                     <MapPin size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-outline/40" />
                     <input 
                       type="text"
                       value={address}
            ...
            <div className="flex gap-4 p-3 sm:p-4 rounded-2xl sm:rounded-3xl bg-background border border-primary/10">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-black text-base sm:text-xl text-on-surface truncate tracking-tight">{place.name}</h4>
                <div className="flex items-center gap-1 text-orange-400 mb-0.5 sm:mb-1">
                  {[1, 2, 3, 4].map(i => <Sparkles key={i} size={12} fill="currentColor" />)}
                  <span className="text-[11px] sm:text-[13px] text-outline font-bold ml-1 tracking-tighter uppercase">(4.5 • 128 đánh giá)</span>
                </div>
                <a 
                ...
                >
                  <MapPin size={10} className="shrink-0 mt-0.5 group-hover/address:scale-125 transition-transform" />
                  <span className="underline decoration-dotted underline-offset-2 decoration-outline/30 group-hover/address:decoration-primary/50">{place.address}</span>
                </a>
              </div>
            </div>
          )}
          ...
          <div className="space-y-4 sm:space-y-5">
            <div className="space-y-1.5 sm:space-y-2">
              <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Chọn ngày ghé thăm</label>
              <div className="relative">
                <Calendar size={16} className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-outline/40" />
                {isCustom ? (
                  <input 
                    type="text" 
                    value={visitDate}
                  ...
                  <select 
                    className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 bg-surface-container border border-outline-variant/10 rounded-xl sm:rounded-2xl text-[13px] font-bold focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none"
                  >
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="space-y-1.5 sm:space-y-2">
                <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Bắt đầu</label>
                <input 
                  type="time" 
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Kết thúc</label>
                <input 
                  type="time" 
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Dự tính chi phí (VNĐ)</label>
              <div className="relative">
                <Wallet size={16} className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-outline/40" />
                <input 
                  type="text" 
                  value={cost}
                  onChange={handleCostChange}
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <label className="text-[9px] sm:text-xs font-black uppercase tracking-widest text-on-surface/60">Ghi chú</label>
              <textarea 
        ...
        <div className="p-4 sm:p-6 bg-surface-container-low/50 flex gap-3 sm:gap-4 border-t border-surface-container-highest">
          {isEdit ? (
            <button 
              className="flex-1 py-3 sm:py-3.5 bg-error text-white font-black text-[9px] sm:text-[10px] uppercase tracking-widest rounded-[4px] shadow-lg shadow-error/20 hover:opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
              Xóa
            </button>
          ) : (
