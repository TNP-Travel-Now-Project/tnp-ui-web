    ...
    >
      ...
      <div className='flex flex-col sm:flex-row sm:items-end justify-between gap-3 text-[#1C1C1E]'>
        <div className='flex-1'>
          ...
          <p className='text-[10px] sm:text-sm font-medium opacity-50 mt-0.5 sm:mt-1'>
            Xây dựng kế hoạch cho chuyến đi của bạn
          </p>
        </div>
        ...
        <div className='lg:col-span-8 space-y-5 sm:space-y-7'>
          <div className='bg-white p-5 sm:p-8 rounded-xl sm:rounded-2xl border border-outline-variant/30 shadow-sm relative'>
            <div className='mb-6 sm:mb-8'>
              ...
              <p className='text-[10px] sm:text-xs text-outline font-medium'>
                  ...
                  >
                    <div className='flex items-center gap-2 sm:gap-3'>
                      ...
                      <div className='text-left'>
                        <p className='text-[8px] sm:text-[10px] text-outline font-bold uppercase mb-0.5'>
                          Thời gian
                        </p>
                        <p className='text-[10px] sm:text-sm font-bold text-on-surface'>
                          <span className='hidden sm:inline'>
                            {formatDateDisplay(startDate, true)} -{' '}
                            {formatDateDisplay(endDate, true)}
                          </span>
                          <span className='sm:hidden'>
                            {formatDateDisplay(startDate, false)} -{' '}
                            {formatDateDisplay(endDate, false)}
                          </span>
                        </p>
                      </div>
                    </div>
                    <ChevronRight
                      size={14}
                      className={`text-outline transition-transform ${showDatePicker ? 'rotate-90' : ''}`}
                    />
                  </button>
                      ...
                      >
                        <div className='space-y-4 sm:space-y-5'>
                          <div className='flex items-center justify-between border-b border-outline-variant/10 pb-3'>
                            <h4 className='text-[10px] sm:text-xs font-black uppercase tracking-[0.1em] text-outline'>
                              Chọn lịch trình
                            </h4>
                            <button
                              onClick={() => setShowDatePicker(false)}
                              className='p-1.5 hover:bg-surface-container rounded-[4px] text-outline'
                            >
                          ...
                          <div className='grid grid-cols-2 gap-3 sm:gap-4'>
                            <div className='space-y-2'>
                              <p className='text-[8px] sm:text-[9px] font-bold text-outline/60 uppercase tracking-wider'>
                                Bắt đầu
                              </p>
                              <DatePickerWithTime
                                date={startDate}
        ...
        <div className='lg:col-span-4 space-y-4 sm:space-y-6'>
          ...
          <div className='bg-white p-4 sm:p-6 rounded-xl border border-outline-variant/30 shadow-sm'>
            <div className='flex items-center justify-between mb-4'>
              <p className='text-[9px] sm:text-xs font-black text-outline/60 uppercase tracking-widest'>
                Điểm đến
              </p>
              <div className='p-1.5 sm:p-2 bg-primary/10 rounded-lg text-primary'>
          ...
          <div className='bg-white p-4 sm:p-6 rounded-xl border border-outline-variant/30 shadow-sm relative overflow-hidden'>
            ...
            <div className='relative z-10'>
              ...
              <p className='text-[8px] sm:text-[10px] text-outline/60 font-medium mt-3 sm:mt-4 italic'>
                Hãy dự trù ngân sách cho chuyến đi này
              </p>
            </div>
          </div>
          ...
          <div className='bg-white p-4 sm:p-6 rounded-xl border border-outline-variant/30 shadow-sm flex flex-col min-h-[220px] sm:min-h-[280px]'>
            <div className='flex items-center justify-between mb-4 sm:mb-6'>
              <h3 className='text-[9px] sm:text-sm font-black text-on-surface uppercase tracking-widest opacity-60'>
                Bạn đồng hành
              </h3>
            ...
            <div className='flex-1 flex flex-col items-center justify-center'>
              <LayoutGroup>
                <div
                  className={`flex items-center w-full relative h-[44px] sm:h-[48px] mb-4 ${isAddingCompanion ? 'justify-start' : 'justify-center'}`}
                >
                  <motion.button
                    layout
