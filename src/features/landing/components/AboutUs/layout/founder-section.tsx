...
export default function FounderSection() {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className='py-16 bg-neutral-0 px-8 md:px-16 mb-0'
    >
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 gap-12 items-center'>
          ...
          <div className='md:col-span-8 space-y-6'>
            <blockquote className='text-[20px] font-medium italic text-slate-700 leading-relaxed'>
              &quot;Sinh ra từ niềm đam mê xê dịch và những trải nghiệm thực tế về sự khó khăn khi
              lên kế hoạch đi chơi cùng bạn bè, tôi muốn tạo ra một công cụ giúp mọi người gạt bỏ
              nỗi lo lắng về lịch trình và tiền bạc để trọn vẹn tận hưởng từng khoảnh khắc.&quot;
            </blockquote>
            <div className='space-y-4 text-slate-600 font-medium text-sm sm:text-base relative'>
              ...
              >
                <p>
                  Tôi tin rằng du lịch là cách tốt nhất để chúng ta thấu hiểu bản thân và kết nối
                  sâu sắc với thế giới xung quanh. Tuy nhiên, việc vận hành một chuyến đi nhóm
                  thường bị cản trở bởi những bảng tính Excel phức tạp, những tranh cãi về chi tiêu
                  và sự lạc lõng trong lịch trình.
                </p>
                <p className='mt-4'>
                  Với nền tảng công nghệ, chudu4be giải quyết bài toán đó một cách mượt mà nhất.
                  Chúng tôi không chỉ làm ứng dụng, chúng tôi xây dựng văn hóa du lịch thông minh
                  tại Việt Nam.
                </p>
              </div>
