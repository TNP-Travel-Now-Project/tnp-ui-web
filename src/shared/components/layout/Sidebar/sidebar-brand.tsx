  ...
  return (
    <div className={`mb-8 mt-2 flex items-center gap-2 ${isExpanded ? 'px-2' : 'justify-center'}`}>
      ...
      <Button
        ...
        className='absolute -right-4 top-6 w-8 h-8 rounded-lg bg-sidebar border border-sidebar-border text-sidebar-foreground hover:text-primary hover:border-primary shadow-md flex items-center justify-center transition-all z-[60]'
      >
