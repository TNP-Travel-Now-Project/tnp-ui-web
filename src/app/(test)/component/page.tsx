...
import { Check, Edit, Eye, Mail, Save, Search, Settings, Trash, User, X } from 'lucide-react'
...
} from '@/shared/components/navigation/DropdownMenu'
import {
  NavigationMenu,
  type NavigationMenuItemProps,
} from '@/shared/components/navigation/NavigationMenu'
  ...
  const navigationItems: NavigationMenuItemProps[] = [
    ...
    },
    {
      ...
      children: [
        {
          label: 'Laptop',
          description: 'Danh sách laptop',
          href: '/products/laptop',
        },
        {
          label: 'Phone',
          description: 'Danh sách điện thoại',
          href: '/products/phone',
        },
      ],
    },
  ...
  return (
    <div className='flex flex-col gap-8 p-8 font-sans min-h-screen'>
      ...
      <section className='space-y-4'>
        ...
        <div>
          <h3 className='text-sm font-medium mb-2'>Dropdown Menu</h3>
          <DropdownMenu
        ...
        <div>
          <h3 className='text-sm font-medium mb-2'>Navigation Menu</h3>
